...
export default function CreateDashboard({ errors }) {
    ...
    const [authMethods, setAuthMethods] = useState(['email']);
    ...
    const handleAuthMethodChange = (method) => {
        ...
        setData('auth_methods', newMethods);
    };

    function submit(e) {
        e.preventDefault();
        post('/master-admin/dashboards');
    }

    return (
        <MasterAdminLayout>
            <Head title="Create Dashboard - Master Admin" />
                    ...
                    <div className="md:flex md:items-center md:justify-between">
                        <div className="min-w-0 flex-1">
                            ...
                            <p className="mt-1 text-sm text-gray-600">
                                Set up a new dashboard type for your application
                            </p>
                        </div>
                    </div>
                                ...
                                <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        <p className="mt-2 text-sm text-gray-500">
                                            Lowercase, no spaces (used for URLs and database)
                                        </p>
                                    </div>
                                    ...
                                    <div className="sm:col-span-6">
                                        <div className="flex items-center">
                                            ...
                                            <label htmlFor="is_active" className="ml-2 text-sm text-gray-700">
                                                Activate dashboard immediately
                                            </label>
                                        </div>
                                    </div>
                                </div>
