...
class User extends Authenticatable
{
    ...
    protected $connection = 'hospital_mysql';
    protected $table = 'users';
    protected $guard_name = 'hospital';
     ...
     */
    public function scopeDashboardType($query, $type = 'hospital')
    {
        if ('separate' === 'shared') {
    ...
    public static function getValidationRules($id = null): array
    {
        ...
        if ('separate' === 'shared') {
            $uniqueEmail .= ",id,dashboard_type,hospital";
            $uniquePhone .= ",id,dashboard_type,hospital";
        }
