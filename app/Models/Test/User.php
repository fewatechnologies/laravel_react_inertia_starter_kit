...
class User extends Authenticatable
{
     ...
     */
    public function scopeDashboardType($query, $type = 'test')
    {
        if ('separate' === 'shared') {
    ...
    public static function getValidationRules($id = null): array
    {
        ...
        if ('separate' === 'shared') {
            $uniqueEmail .= ",id,dashboard_type,test";
            $uniquePhone .= ",id,dashboard_type,test";
        }
